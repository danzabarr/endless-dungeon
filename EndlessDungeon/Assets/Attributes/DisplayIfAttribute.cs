...
public class DisplayIfAttribute : PropertyAttribute
{
    ...
    public DisplayIfAttribute(string comparedPropertyName, params object[] comparedValue)
    {
    ...
    public DisplayIfAttribute(string comparedPropertyName, object comparedValue, DisablingType disablingType = DisablingType.DontDraw)
    {
        this.comparedPropertyName = comparedPropertyName;
        this.comparedValue = new object[] { comparedValue };
