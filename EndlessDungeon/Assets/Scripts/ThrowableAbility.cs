...
public class ThrowableAbility : Ability
{
    ...
    )
    {
        ...
        Instantiate(Throwable, caster.GetCastPosition(), caster.GetCast().rotation * Quaternion.Euler(-45, 0, 0), objects.transform).ThrowAt(caster, throwTarget, Damage * damageMultiplier, DmgType);
    }
}
